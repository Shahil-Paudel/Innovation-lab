...
import TripFacts from "../sections/PackageDetailComponent/TripFacts";
import Overview from "../sections/PackageDetailComponent/Overview";
import IncludesExcludes from "../sections/PackageDetailComponent/IncludesExcludes";

const API_URL = "/gateway-api/v1/popular-packages";

const IMAGE_BASE_URL = "https://gatewaytreks.com/public/uploads/frontend/full/";
...
const PackageDetail = () => {
  ...
  useEffect(() => {
    ...
    const fetchPackage = async () => {
      try {
        ...
        console.log("Fetching package because state is unavailable. ID:", id);
        ...
        const packages = Array.isArray(data.popular_packages)
  ...
  const title = trip.title || trip.name || "Untitled Package";

  const duration = trip.duration ?? "N/A";

  const rating = trip.rating ?? "N/A";

  const reviews = trip.review_count ?? trip.reviews ?? null;
  ...
  const region = trip.destslug || trip.destination || "Nepal";
        ...
        <div className="mx-auto max-w-7xl px-6 py-8 md:px-10">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-x-5 gap-y-3">
            <div className="flex items-center gap-2">
              <Star size={18} fill="currentColor" className="text-[#f5b942]" />
      ...
      <div className="mx-auto max-w-7xl px-6 py-10 md:px-10">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            ...
            <section>
              <Overview description={trip.description} />
            </section>
            <IncludesExcludes
              costIncludes={trip.cost_includes}
              costExcludes={trip.cost_excludes}
            />
          </div>
...
const TrustItem = ({ icon, text }) => {
  return (
    <div className="flex items-center gap-2.5">
      <div className="text-[#4f8f3a]">{icon}</div>
